function TeethModel() {
  ...
  this.initAll = function (viev, controller) {//game initialization
    vievName = viev;
  ...
  this.levelsGenerator = function () {
    ...
    let weaponPercents = [15, 10, 8, 7, 6] // % вероятности выпадения оружия вместо еды
    let foodPosition = [250, 750];
    let levelsLength = [15, 20, 30, 35, 40];
    let levelsFood = [12, 20, 30, 100, 150];
